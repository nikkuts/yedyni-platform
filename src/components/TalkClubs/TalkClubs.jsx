...
export default function TalkClubs () {
    ...
    return (
      <div className={css.wrapper}>
        ...
        <p className={css.text}>Якщо поблизу вас ще не має розмовного клубу, станьте його організатором. Це найкращий спосіб популяризації проєкту та розширення своєї команди!</p>
        <p className={css.text}>Маєте намір організувати розмовний клуб? Зв’яжіться з нами, і ми допоможемо вам це зробити. Напишіть нашому модератору у чаті підтримки.</p>
        <p className={css.text}>Нагадуємо, що Ви також можете брати участь у розмовних клубах онлайн. Їх розклад та анонси регулярно публікуються у чатах підтримки.</p>
