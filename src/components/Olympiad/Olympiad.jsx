  ...
  const navigate = useNavigate();
    ...
    return (
      <div className={css.container}>
        ...
        <h2 className={css.subtitle}>Наступна олімпіада відбудеться вже скоро. <br/>Слідкуйте за оновленнями.</h2>
        {/* <ul>
          <li>
        ...
        <h2 className={css.subtitle}>Переможці отримують приємні подарунки від проєкту!</h2>
        <button 
              type="button"
              onClick={() => navigate("/uk/game")} 
              className={css.button}
