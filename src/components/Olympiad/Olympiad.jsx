...
export default function Olympiad () {
  const navigate = useNavigate();
    ...
    return (
      ...
      <p>Учасники, які надали більше <span className={css.num}>70%</span> правильних відповідей отримують призові бали.</p>
      <p>Кількість балів, яку отримує учасник, залежить від поточного значення його особистого рівня стабільності підтримки проєкту (див. табл)</p>
      <p>Таку саму кількість балів отримує запрошувач, до команди якого входить даний учасник.</p>
      <div className={css.tableTournament}>
        <table className={css.table}>
          <thead>
              <tr>
                  <th className={css.th}>Особистий рівень стабільності підтримки проєкту учасника</th>
      ...
      <p>Призовий фонд складає <span className={css.num}>10%</span> від загальної суми підтримки проєкту, зробленої усіма користувачами платформи за період з моменту завершення попередньої олімпіади.</p>
