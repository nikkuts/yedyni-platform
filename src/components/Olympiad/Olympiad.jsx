  ...
  const navigate = useNavigate();
    ...
    return (
      <div className={css.container}>
        ...
        <p>При однаковій кількості балів перевага надається учаснику, який має вищий рівень стабільності підтримки проєкту.</p>
        <p>При однаковому значенні рівня стабільності підтримки перевага надається учаснику, який має вищий українськомовний слід.</p>
      </div>
    )
}